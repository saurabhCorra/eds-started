...
## Environments
- Preview: https://main--eds-started--saurabhCorra.aem.page/
- Live: https://main--eds-started--saurabhCorra.aem.live/
...
1. Open the `eds-started` directory in your favorite IDE and start coding :)
